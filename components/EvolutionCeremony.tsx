    ...
    <AnimatePresence>
      ...
      >
        ...
        {phase === 'text' && (
          ...
          >
            <motion.p
              className="text-4xl font-bold text-white mb-2 drop-shadow-[0_0_20px_rgba(79,70,229,0.8)]"
              initial={{ y: 20 }}
              animate={{ y: 0 }}
            ...
            <motion.div
              className="mt-4 h-1 w-24 mx-auto rounded-full bg-indigo-500/50"
              initial={{ scaleX: 0 }}
              animate={{ scaleX: 1 }}
