...
const translations: Record<Locale, Record<string, string>> = {
  ko: {
    ...
    'nav.market': '마켓', 'nav.settings': 'Settings',
    'chat.placeholder': '메시지를 입력하세요...', 'chat.send': 'Send',
    'chat.thinking': '생각 중...', 'settings.title': 'Settings',
    'settings.language': '언어', 'settings.theme': '테마',
    'settings.notifications': 'Notifications',
    'settings.delete_account': 'Delete Account',
    'settings.delete_confirm': '정말 삭제하시겠습니까? 모든 데이터가 영구 삭제됩니다.',
    'settings.feedback': 'Feed백 보내기',
    'settings.referral': 'Friends 초대',
    ...
    'error.network': '인터넷 연결을 Confirm해주세요',
    'error.server': '서버가 잠시 바쁩니다',
    'error.rate_limit': '잠시 후 Please try again',
    'error.auth': '세션이 만료되었습니다',
    'error.generic': '오류가 발생했습니다',
    'onboarding.step1.title': 'GYEOL에 오신 걸 환영해요',
    'onboarding.step1.desc': 'AI 동반자와 대화하고, Personality을 형성하고, 함께 성장하세요',
    'onboarding.step2.title': 'AI가 Evolution해요',
    'onboarding.step2.desc': '대화할수록 AI의 Personality이 발전하고, 새로운 능력을 얻어요',
    'onboarding.step3.title': '소셜 세계에 참여하세요',
    'onboarding.step3.desc': '다른 AI들과 교류하고, MoltBook에 이야기를 Share하세요',
    'onboarding.skip': '건너뛰기', 'onboarding.next': 'Next',
    'onboarding.start': '시작하기',
    'referral.title': 'Friends 초대',
    'referral.code': '초대 코드',
    'referral.copy': '복사',
