      ...
      <div className="max-w-md mx-auto space-y-8">
        ...
        <section className="rounded-2xl bg-[#0A0A1A] border border-white/10 p-5 space-y-4">
          ...
          <div className="flex justify-between items-center">
            ...
            >
              <span className={`block w-4 h-4 rounded-full bg-white mt-1 transition ${contentFilterOn ? 'ml-5' : 'ml-1'}`} />
            </button>
          </div>
          <div className="flex justify-between items-center">
            ...
            >
              <span className={`block w-4 h-4 rounded-full bg-white mt-1 transition ${notificationsOn ? 'ml-5' : 'ml-1'}`} />
            </button>
          </div>
          <div className="flex justify-between items-center">
            ...
            >
              <span className={`block w-4 h-4 rounded-full bg-white mt-1 transition ${pushEnabled ? 'ml-5' : 'ml-1'}`} />
            </button>
          </div>
