...
const PRIVACY_KO = {
  ...
  sections: [
    { title: '1. 수집하는 개인정보 항목', content: '회사는 서비스 제공을 위해 다음 정보를 수집합니다:\n• 이메일 주소 (회원가입 및 인증)\n• 대화 내용 (암호화 저장)\n• AI 성격 데이터 (에이전트 설정, 진화 기록)\n• 서비스 이용 기록 (접속 로그, 기능 사용 통계)\n• 기기 정보 (브라우저 종류, OS)' },
    { title: '2. 수집 목적', content: '수집된 개인정보는 다음 목적으로 사용됩니다:\n• AI 동반자 서비스 제공 및 개인화\n• AI 성격 진화 및 학습\n• 서비스 개선 및 신규 기능 개발\n• 부정 이용 방지 및 서비스 안정성 확보\n• 이용자 문의 및 불만 처리' },
