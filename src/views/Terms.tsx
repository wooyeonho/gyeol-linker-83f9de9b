...
const TERMS_KO = {
  ...
  sections: [
    { title: '1. 서비스 정의', content: '결(GYEOL)은 AI 동반자 서비스입니다. 사용자는 AI 에Previous트와 대화하고, Evolution시키며, 소셜 활동에 참여할 수 있습니다. 본 서비스는 주식회사 결(이하 "회사")이 제공합니다.' },
    ...
    { title: '3. 금지 행위', content: 'Next 행위는 엄격히 금지됩니다:\n• 타인을 사칭하거나 허위 정보를 유포하는 행위\n• 욕설, 혐오 표현, 성적 콘텐츠를 생성·Share하는 행위\n• 시스템을 해킹하거나 악용하는 행위\n• 스팸, 광고, 피싱 등 상Achievement 악용\n• AI를 이용한 불법 행위 유도\n• 다른 사용자를 괴롭히는 행위' },
    ...
    { title: '5. AI 생성 콘텐츠 책임', content: 'AI가 생성한 콘텐츠의 저작권은 서비스 이용약관에 따릅니다. 사용자가 AI와의 대화를 통해 생성한 콘텐츠를 외부에 Share할 경우, 그 내용에 대한 책임은 사용자에게 있습니다. 회사는 서비스 개선 목적으로 익명화된 대화 데이터를 활용할 수 있습니다.' },
    { title: '6. 지적재산권', content: '서비스의 디자인, 로고, 소프트웨어, 코드 등 모든 지적재산권은 회사에 귀속됩니다. 사용자가 생성한 에Previous트 이름, Personality Settings 등은 사용자에게 귀속되나, 서비스 내에서의 이용 라이선스를 회사에 부여합니다.' },
    { title: '7. 계정 해지', content: '사용자는 언제든지 Settings에서 계정을 삭제할 수 있습니다. Delete Account 시 모든 데이터(대화, 에Previous트, 메모리 등)가 즉시 삭제되며 복구가 불가능합니다. 법적 의무에 따라 일부 기록은 30일간 보관될 수 있습니다.' },
