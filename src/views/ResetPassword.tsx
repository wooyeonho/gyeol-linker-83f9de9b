        ...
        <div className="glass-panel rounded-2xl p-8 w-full">
          <div className="mb-8 flex flex-col items-center">
            <div className="w-16 h-16 rounded-full bg-gradient-to-br from-primary/30 to-secondary/20 flex items-center justify-center mb-4">
              <span aria-hidden="true" className="material-icons-round text-2xl text-primary">lock_reset</span>
            </div>
          ...
          {success ? (
            <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }}
              ...
              <div className="w-12 h-12 rounded-full bg-[hsl(var(--success,142_71%_45%)/0.1)] flex items-center justify-center mx-auto">
                <span aria-hidden="true" className="material-icons-round text-[hsl(var(--success,142_71%_45%))] text-2xl">check_circle</span>
              </div>
            ...
            <form onSubmit={handleReset} className="space-y-4">
              ...
              <button type="submit" disabled={loading}
                ...
                {!loading && <span aria-hidden="true" className="material-icons-round text-base">check</span>}
              </button>
            </form>
          )}
        </div>
