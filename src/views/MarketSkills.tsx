      ...
      <div className="max-w-md mx-auto p-5 pt-6 space-y-5 relative z-10">
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center gap-3 py-16">
            ...
            <p className="text-sm text-foreground/60 font-medium">No skills available yet</p>
            <p className="text-[11px] text-muted-foreground text-center max-w-[240px]">Be the first to submit a skill for the community!</p>
          </div>
        ) : (
